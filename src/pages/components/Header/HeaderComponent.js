                ...
                <div class="wrapper__profile">
                    ...
                    <ul class="profile__social">
                        <li class="social__item">
                            <a href="https://www.linkedin.com/in/marcela-afonso-999954b3/" title="LinkedIn" class="item__link" target="_blank">
                        ...
                        <li class="social__item">
                            <a href="https://github.com/mahafonso" title="GitHub" class="item__link" target="_blank">
                        ...
                        <li class="social__item">
                            <a href="https://codepen.io/marcela_afonso" title="CodePen" class="item__link" target="_blank">
                                <svg id="regular" enable-background="new 0 0 24 24" height="30" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg">
