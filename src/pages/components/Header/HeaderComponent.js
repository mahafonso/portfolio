    ...
    return (
        <header class="header">
            <div class="header__wrapper">
                <div class="header__wrapper-image"></div>
                ...
                <div class="header__wrapper-profile">
                    ...
                    <ul class="profile__social">
                        <li class="social__item">
                            <a href="https://www.linkedin.com/in/marcela-afonso-999954b3/" title="LinkedIn" class="item__link linkedin">
                        ...
                        <li class="social__item">
                            <a href="https://github.com/mahafonso" title="GitHub" class="item__link github">
